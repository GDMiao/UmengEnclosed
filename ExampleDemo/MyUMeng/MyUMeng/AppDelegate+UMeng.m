...
- (void)configUSharePlatforms
{
	...
	[[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:@"appKey"  appSecret:@"设置新浪的appKey和appSecret" redirectURL:@"https://sns.whalecloud.com/sina2/callback"];
